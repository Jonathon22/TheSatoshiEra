IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'UserTypes') DELETE from UserTypes;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'Users') DELETE from Users;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'About') DELETE from About;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'Library') DELETE from Library;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'LibraryCategories') DELETE from LibraryCategories;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'TutorialVideos') DELETE from TutorialVideos;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'Comics') DELETE from Comics;
IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'VideoViewed') DELETE from VideoViewed;


IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'TutorialVideos')
ALTER TABLE dbo.TutorialVideos 
DROP CONSTRAINT FK_TutorialVideos_LibraryId;

IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'Library')
ALTER TABLE dbo.Library 
DROP CONSTRAINT FK_Library_UserId;

IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'Library')
ALTER TABLE dbo.Library 
DROP CONSTRAINT FK_Library_CategoryId;




IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = 'VideoViewed')
ALTER TABLE dbo.VideoViewed 
DROP CONSTRAINT FK_VideoViewed_UserId;

IF EXISTS (SELECT * FROM Information_schema.TABLES WHERE TABLE_NAME = '')
ALTER TABLE dbo.Users 
DROP CONSTRAINT FK_Users_UserTypes;
